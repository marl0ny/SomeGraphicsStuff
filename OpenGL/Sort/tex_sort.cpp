...
Sort::Sort(int w, int h, 
    ComparisonMethod comparison_method,
    ComparisonParams params
): m_programs(), m_frames(Frames(w, h)) {
    m_comparison_method = comparison_method;
    m_params = params;
}

Sort::Sort(
    IVec2 d_2d, ComparisonMethod comparison_method, ComparisonParams params
): m_programs(), m_frames(Frames(d_2d[0], d_2d[1])) {
    m_comparison_method = comparison_method;
    m_params = params;
}
...
Sort::Sort(int w, int h, 
    ...
    m_comparison_method = comparison_method;
    m_params = ComparisonParams{};
}

Sort::Sort(
    IVec2 d_2d, ComparisonMethod comparison_method
): m_programs(), m_frames(Frames(d_2d[0], d_2d[1])) {
    m_comparison_method = comparison_method;
    m_params = ComparisonParams{};
}
